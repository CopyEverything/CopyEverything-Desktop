...
View {
    ...
    height: targetHeight
    elevation: !page || backgroundColor === page.color ? 0 : page.actionBar.elevation
    fullWidth: true
    clipContent: true
    ...
    Rectangle {
        ...
        color: page && page.rightSidebar && page.rightSidebar.actionBar.backgroundColor
    ...
    Controls.StackView {
        ...
        anchors {
            ...
            rightMargin: page && page.rightSidebar ? page.rightSidebar.anchors.rightMargin : 0
        }
